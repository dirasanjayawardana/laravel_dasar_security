...
class UserTest extends TestCase
{
    ...
    public function testAuth()
    {
        ...
        self::assertEquals("dira@localhost", $user->email);
    }
    ...
    public function testLogin()
    {
        ...
        $this->get("/users/login?email=dira@localhost&password=rahasia")
    ...
    public function testCurrent()
    {
        ...
        $user = User::where("email", "dira@localhost")->firstOrFail();
        $this->actingAs($user)
            ->get("/users/current")
            ->assertSeeText("Hello Dira Sanjaya");
    }
